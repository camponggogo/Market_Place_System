...
TRANSLATIONS = {
    ...
    # Admin Dashboard
    "admin_title": {"th": "Food Court Management System", "en": "Food Court Management System", "zh": "美食广场管理系统", "ru": "Система управления фудкортом"},
    ...
    # Customer
    "customer_title": {"th": "Food Court - ลูกค้า", "en": "Food Court - Customer", "zh": "美食广场 - 客户", "ru": "Фудкорт - Клиент"},
    ...
    # Customer QR
    "customer_qr_title": {"th": "Food Court ID QR Code", "en": "Food Court ID QR Code", "zh": "美食广场ID二维码", "ru": "QR код Food Court ID"},
    "foodcourt_id_label": {"th": "กรอก Food Court ID", "en": "Enter Food Court ID", "zh": "输入美食广场ID", "ru": "Введите Food Court ID"},
    ...
    "how_to_1": {"th": "กรอก Food Court ID ของคุณ", "en": "Enter your Food Court ID", "zh": "输入您的美食广场ID", "ru": "Введите ваш Food Court ID"},
